<div>
    <section class="py-5 mt-80">
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            <div class="bg-slate-950 rounded-lg shadow " style="width: 60%">
                    ...
                    <form class="space-y-4 md:space-y-6" wire:submit="save">
                        ...
                        <div>
                            ...
                            <input type="email" wire:model="email"
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 "
                                placeholder="name@rush2homes.com" required="">
                        </div>
                        <div>
                            <label for="password"
                        ...
                        <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                            Already have an account? <a href="{{ route('filament.admin.auth.login') }}"
